...
if plot_dict['MMSE'] == 1:
    MMSE = np.load("MMSE/MMSE,na=1,nq=100,thresh=0,snap=12000,monte=1200.npy")#[MMSE_func(sigma_space[i], sigma_space[i], na, nq, matrix_const1, 5000,bound_sim) for i in range(len(sigma_space))]
