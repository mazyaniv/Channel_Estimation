...
# WBCRB = np.load(f'WBCRB_Mixed/WBCRB,na={na},nq={nq},sim=50.npy') #[weighted_BCRB(sigma_space[i], sigma_space[i], na, nq,matrix_const1, monte) for i in range(len(sigma_space))]
...
# plt.plot(10 * np.log10(1 / sigma_space2), MMSE, linestyle='-.',color='red', label="MMSE")
