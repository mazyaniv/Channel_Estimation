...
if plot_dict['Approx'] == 1:
    ...
    BCRB_a = [weighted_BCRB(sigma_space[i], sigma_space[i], na, 0, matrix_const0,bound_sim) for i in range(len(chosen_space))]
...
if plot_dict['OPT'] == 1:
    OPT = [optimized_weighted_BCRB(sigma_space[i], sigma_space[i], na, nq, matrix_const1,bound_sim) for i in range(len(chosen_space))]
...
if plot_dict['BCRB'] == 1:
    BCRB = [CRB(sigma_space[i], sigma_space[i], na, nq, matrix_const1, 10000) for i in range(len(chosen_space))]
